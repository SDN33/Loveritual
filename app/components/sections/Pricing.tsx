    ...
    <section id="pricing" className="py-20 bg-gradient-to-b from-white to-[#F2C4CE]/20">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-3xl mx-auto">
          <div className="bg-gradient-to-r from-[#FFE4EF] to-[#FFF8FA] rounded-2xl p-6 shadow-md border border-[#7D0633]/10">
            <div className="flex flex-col md:flex-row items-center gap-4">
              <div className="flex-shrink-0 bg-[#7D0633] p-3 rounded-full">
                <GiftIcon className="w-10 h-10 text-white" />
              </div>
              
              <div className="flex-grow">
                <h3 className="text-xl font-bold text-[#7D0633] mb-2">Offrir LoveRitual en cadeau</h3>
                <p className="text-gray-700 mb-3 text-sm md:text-base">
                  LoveRitual est un cadeau parfait pour un couple ami, des jeunes mariés ou pour célébrer un anniversaire de relation. Vous pouvez choisir entre différentes durées d&apos;abonnement cadeau.
                </p>
                
                <div className="flex flex-wrap gap-3 mt-3">
                  <div className="flex-1 min-w-[120px] bg-white rounded-lg p-3 text-center shadow-sm hover:shadow-md transition-shadow">
                    <span className="text-[#7D0633] font-bold text-lg mb-1 block">3 mois</span>
                    <span className="text-gray-700 text-xs">à partir de 59,70€</span>
                  </div>
                  <div className="flex-1 min-w-[120px] bg-white rounded-lg p-3 text-center shadow-sm hover:shadow-md transition-shadow">
                    <span className="text-[#7D0633] font-bold text-lg mb-1 block">6 mois</span>
                    <span className="text-gray-700 text-xs">à partir de 113,40€</span>
                    <span className="bg-[#7D0633] text-white text-xs px-2 py-0.5 rounded-full ml-1">-5%</span>
                  </div>
                  <div className="flex-1 min-w-[120px] bg-white rounded-lg p-3 text-center shadow-sm hover:shadow-md transition-shadow">
                    <span className="text-[#7D0633] font-bold text-lg mb-1 block">12 mois</span>
                    <span className="text-gray-700 text-xs">à partir de 214,92€</span>
                    <span className="bg-[#7D0633] text-white text-xs px-2 py-0.5 rounded-full ml-1">-10%</span>
                  </div>
                </div>
              
              </div>
              <div className="flex justify-center w-fit mt-4 mx-auto">
                  <button className="bg-[#7D0633] text-white py-2 px-5 rounded-full font-semibold hover:bg-[#7D0633]/90 transition-colors flex items-center justify-center gap-2 text-sm">
